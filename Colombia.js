...
export default async function Colombia(clearDirectory) {
  ...
  await page.goto(
    "https://www.blackrock.com/co/productos/lista-de-producto#!type=ishares&style=All&view=perfNav&pageSize=25&pageNumber=1&sortColumn=totalNetAssetsFund&sortDirection=desc"
  );
