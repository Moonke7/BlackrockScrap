...
export default async function UnitedStates(clearDirectory) {
  ...
  await page.goto(
    "https://www.blackrock.com/us/individual/products/investment-funds#type=all&tab=averageAnnualReturnNAV&style=All&view=perfNav&pageSize=25&pageNumber=1&sortColumn=totalNetAssets&sortDirection=desc"
  );
