...
export default async function AmericasOffShors(clearDirectory) {
  ...
  await page.goto(
    "https://www.blackrock.com/americas-offshore/en/products/product-list#/?productView=all&pageNumber=1&sortColumn=totalNetAssetsFund&sortDirection=desc&dataView=perfNav"
  );
  await page.waitForSelector("#onetrust-accept-btn-handler");
  await page.click("#onetrust-accept-btn-handler");
  await new Promise((resolve) => setTimeout(resolve, 1000));
  await page.click("#terms-and-conditions-masthead-accept");
  ...
  await page.waitForSelector("mat-checkbox");
  const articulos2 = await page.$$("mat-checkbox");
  await articulos2[5].click();
  await new Promise((resolve) => setTimeout(resolve, 1000));
