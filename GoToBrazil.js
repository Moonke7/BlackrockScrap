...
export default async function GoToBrazil(clearDirectory) {
  ...
  await page.goto(
    "https://www.blackrock.com/br/products/product-list#!type=ishares&style=All&view=perfDiscrete&pageSize=25&pageNumber=1&sortColumn=totalNetAssets&sortDirection=desc"
  );
